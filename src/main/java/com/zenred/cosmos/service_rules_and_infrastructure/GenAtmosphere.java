...
public class GenAtmosphere {
	...
	static {
		...
		ruleMap.put("BLUE_SG_II" + "7" + "0", new AtmosphereResolutionIF() {
			public List<Atmosphere> resolve(StarFactory starFactory) {
				return null;
			}
		});

		ruleMap.put("BLUE_SG_II" + "7" + "1", new AtmosphereResolutionIF() {
			public List<Atmosphere> resolve(StarFactory starFactory) {
				return null;
			}
		});

		ruleMap.put("BLUE_SG_II" + "7" + "2", new AtmosphereResolutionIF() {
			public List<Atmosphere> resolve(StarFactory starFactory) {
				return null;
			}
		});

		ruleMap.put("BLUE_SG_II" + "7" + "3", new AtmosphereResolutionIF() {
			public List<Atmosphere> resolve(StarFactory starFactory) {
				return null;
			}
		});

		ruleMap.put("BLUE_SG_II" + "7" + "4", new AtmosphereResolutionIF() {
			public List<Atmosphere> resolve(StarFactory starFactory) {
				return null;
			}
		});

		ruleMap.put("BLUE_SG_II" + "7" + "5", new AtmosphereResolutionIF() {
			public List<Atmosphere> resolve(StarFactory starFactory) {
				return null;
			}
		});
		...
		ruleMap.put("LTBL_SG_II" + "7" + "0", new AtmosphereResolutionIF() {
			public List<Atmosphere> resolve(StarFactory starFactory) {
				return null;
			}
		});

		ruleMap.put("LTBL_SG_II" + "7" + "1", new AtmosphereResolutionIF() {
			public List<Atmosphere> resolve(StarFactory starFactory) {
				return null;
			}
		});

		ruleMap.put("LTBL_SG_II" + "7" + "2", new AtmosphereResolutionIF() {
			public List<Atmosphere> resolve(StarFactory starFactory) {
				return null;
			}
		});

		ruleMap.put("LTBL_SG_II" + "7" + "3", new AtmosphereResolutionIF() {
			public List<Atmosphere> resolve(StarFactory starFactory) {
				return null;
			}
		});

		ruleMap.put("LTBL_SG_II" + "7" + "4", new AtmosphereResolutionIF() {
			public List<Atmosphere> resolve(StarFactory starFactory) {
				return null;
			}
		});

		ruleMap.put("LTBL_SG_II" + "7" + "5", new AtmosphereResolutionIF() {
			public List<Atmosphere> resolve(StarFactory starFactory) {
				return null;
			}
		});
